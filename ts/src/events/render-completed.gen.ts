// To parse this data:
//
//   import { Convert, RenderCompletedEvent } from "./render-completed.gen";
//
//   const renderCompletedEvent = Convert.toRenderCompletedEvent(json);
//
...
export class Convert {
    public static toRenderCompletedEvent(json: string): RenderCompletedEvent {
        return cast(JSON.parse(json), r("RenderCompletedEvent"));
    }

    public static renderCompletedEventToJson(value: RenderCompletedEvent): string {
        return JSON.stringify(uncast(value, r("RenderCompletedEvent")), null, 2);
    }
}
...
const typeMap: any = {
    "RenderCompletedEvent": o([
        ...
        { json: "render_ms", js: "render_ms", typ: 0 },
