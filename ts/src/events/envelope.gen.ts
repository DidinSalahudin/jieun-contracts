// To parse this data:
//
//   import { Convert, EventEnvelope } from "./envelope.gen";
//
//   const eventEnvelope = Convert.toEventEnvelope(json);
//
...
export class Convert {
    public static toEventEnvelope(json: string): EventEnvelope {
        return cast(JSON.parse(json), r("EventEnvelope"));
    }

    public static eventEnvelopeToJson(value: EventEnvelope): string {
        return JSON.stringify(uncast(value, r("EventEnvelope")), null, 2);
    }
}
